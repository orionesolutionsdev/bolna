...
transcribers = [
    TranscriberRes(sampling_rate=16000, endpointing=400, keywords="", stream=True, model="nova-2-general-en", language="en", encoding="linear16", provider="deepgram", task="transcribe", id="nova-2-general"),
