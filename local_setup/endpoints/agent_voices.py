...
voices = [
    ...
    Voice(provider="deepgram", audio="/assets/audio/Athena-C6a_6S3K.wav", name="Athena", model="aura-athena-en", id="athena-voice-id", languageCode="en-UK", accent="british", gender="female", lowLatency=False),
    Voice(provider="deepgram", audio="/assets/audio/Hera-Ck3-0iA9.wav", name="Hera", model="aura-hera-en", id="hera-voice-id", languageCode="en-US", accent="american", gender="female", lowLatency=False),
    Voice(provider="deepgram", audio="/assets/audio/Orion-Ck3-0iA9.wav", name="Orion", model="aura-orion-en", id="orion-voice-id", languageCode="en-US", accent="american", gender="male", lowLatency=False),
    Voice(provider="deepgram", audio="/assets/audio/Arcas-u3w4z1vR.mp3", name="Arcas", model="aura-arcas-en", id="arcas-voice-id", languageCode="en-US", accent="american", gender="male", lowLatency=False),
    Voice(provider="deepgram", audio="/assets/audio/Perseus-Ck3-0iA9.wav", name="Perseus", model="aura-perseus-en", id="perseus-voice-id", languageCode="en-US", accent="american", gender="male", lowLatency=False),
